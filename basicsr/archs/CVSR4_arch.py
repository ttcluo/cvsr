...
class CVSR4(nn.Module):
    ...
    def __init__(self, num_feat=64, num_block=30, spynet_path=None):
        ...
        self.complexConv1 = ComplexResidualBlockNoBNbase()
    ...
    def forward(self, x):
        ...
        for i in range(0, n):
            ...
            real,img = self.complexConv1(feat_prop, out_l[i])
            ...
            newreal = real * attcos
            newimg = img *attsin
            attreal = real+self.convreal(newreal)
            attimg = img+self.convimg(newimg)
