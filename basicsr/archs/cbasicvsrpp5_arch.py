...
class CBasicVSRPlusPlus5(nn.Module):
    ...
    def __init__(self,
        ...
        self.reconstruction = ConvResidualBlocks(5 * mid_channels, mid_channels, 3)
        self.reconstruction2 = ConvResidualBlocks(5 * mid_channels, mid_channels, 2)
    ...
    def upsample(self, lqs, feats):
        ...
        for i in range(0, lqs.size(1)):
            ...
            real = self.reconstruction(hr)
            img = self.reconstruction2(hr)
            ...
            hr = torch.cat([attreal, attimg], dim=1)
            hr = self.fusion(hr)
